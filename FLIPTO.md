...
- MATCH_RECOGNIZE, CREATE CONSTANT, and some nested WITH RECURSIVE
  shapes (recursive references inside subqueries or nested unions) are
  not supported.
