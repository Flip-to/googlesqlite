...
- Statements that mention TIMESTAMP analyze with literal-cast folding
  off (go-googlesql v0.4.0 cannot set a UTC default time zone). NUMERIC
  literal casts are handled; other folded-literal differences in such
  statements may remain until go-googlesql exposes a UTC TimeZone.
