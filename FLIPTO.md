...
- CAST(STRING AS DATE / DATETIME / TIME / TIMESTAMP FORMAT ...) ignores
  the format and falls back to the plain cast; only the to-STRING
  direction honours format elements.
- Anonymous STRUCT field names in some results (flipto-dbt S36).
